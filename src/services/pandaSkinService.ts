...
import { PandaSkinRecord, SkinRarity, SkinType } from '@/types/skins';

// Using SkinType and SkinRarity from types/skins.ts instead of local enums

// Using PandaSkinRecord from types/skins.ts instead of local interface

// Extended interface for internal use that includes additional properties
export interface ExtendedPandaSkinRecord extends PandaSkinRecord {
  imagePath?: {
